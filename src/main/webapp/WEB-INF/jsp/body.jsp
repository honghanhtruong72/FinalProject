...
<div class="wrapper-sub">
    ...
    <main class="main-content">
        <div style="height: 870px;background-color: #0d41a8;">
            <div class="container">
            ...
            <div class="wrap-size container" style="top: -120px;">
                ...
                <div class="btn_practice_body">
                    <a href="example?id=6"><img style="width: 250px; height: 150px" src="/resources/images/next.png" id="next-animal-1"></a>
                </div>
            </div>
        </div>
    </main>
