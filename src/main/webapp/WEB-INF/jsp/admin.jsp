            ...
            <div class="container">
                <div class="row">
                    <ul class="nav col-12 justify-content-center">
                        ...
                        <li class="nav-item  header-menu-home" id="btn_feedback">
                            <a href="admin" class="nav-link"  style="color: #fff;">FEEDBACK</a>
                        </li>
    ...
    <main class="main-content">
        <div style="height: 100%;background-color: #0d41a8;">
            ...
            <div class="wrap container">
                <h1 style="text-align: center; color: white;"><strong>Feedback of User</strong></h1><br>
                <div class="jumbotron" style="font-size: 18px;">
                    <c:forEach items="${messages}" var="message">
                        <form action="sendMessage?email=${message.email}&content=${message.content}" method="post">
                            ...
                            <textarea name="mess" cols="80" rows="2" style="width: 100%" placeholder="Reply...."></textarea><br>
