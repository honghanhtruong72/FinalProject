            ...
            <div class="wrap-size container">
                <form>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image1"><img src="/resources/images/furniture/clock.jpeg"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image2"><img src="/resources/images/furniture/bàn.png"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image3"><img src="/resources/images/furniture/abc%20(2).jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image4"><img src="/resources/images/furniture/books.jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image5"><img src="/resources/images/furniture/va.jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                            <div class="col-md-7" style="padding-top: 10%; left: 10%; font-size: 30px">
                                <div class="text-left">This is &nbsp;&nbsp;
                                    <select id="select5">
                                        <option value="">Furniture</option>
                                        <option value="">Bed</option>
                                        <option value="">Swivel chair</option>
