            ...
            <div class="wrap-size container">
                <form>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image1"><img src="/resources/images/furniture/tủ%20lạnh.jpg"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image2"><img src="/resources/images/furniture/bin.jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image3"><img src="/resources/images/furniture/amdun.jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image4"><img src="/resources/images/furniture/lovisong.jpg"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-right" id="image5"><img src="/resources/images/furniture/noicomdien.png"
                                                                         style="width: 250px; height: 250px">
                                </div>
                            </div>
                            <div class="col-md-7" style="padding-top: 10%; left: 10%; font-size: 30px">
