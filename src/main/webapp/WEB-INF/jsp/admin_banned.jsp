            ...
            <div class="container">
                <div class="row">
                    <ul class="nav col-12 justify-content-center">
                        ...
                        <li class="nav-item header-menu-home" id="btn_user_ban">
                            <a href="admin_banned" class="nav-link" style="color: #fff;">USER BANNED</a>
                        </li>
        ...
        <div style="height: 100%;background-color: #0d41a8;">
            ...
            <div class="wrap container">
                ...
                <table class="table" id="dataTable" style="color: white">
                    ...
                    <tbody>
                    <c:forEach items="${usersBanned}" var="user">
                        <tr>
                            <td>${user.id}</td>
                            <td>${user.userName}</td>
                            <td>${user.email}</td>
                            <td>${user.phone}</td>
                            <td><button class="confirm btn btn-danger" onclick="enableUser(${user.id})">
