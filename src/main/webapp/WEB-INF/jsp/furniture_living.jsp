    ...
    <main class="main-content">
        <div style="height: 1300px;background-color: #0d41a8;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 style="font-size: 100px; color: #cfecf6;">Living Room</h1>
                    </div>
                </div>
            </div>
            <div class="wrap container">
                <div class="row">
                    <img class="col-sm-3 size-test" id="table" src="/resources/images/furniture/table.jpg" alt="table" onclick="clickImageLiving(this)">
                    <img class="col-sm-3 size-test" id="telephone" src="/resources/images/furniture/telephone.jpg" alt="telephone" onclick="clickImageLiving(this)">
                    <img class="col-sm-3 size-test" id="armchair" src="/resources/images/furniture/armchair.jpg" alt="armchair" onclick="clickImageLiving(this)">
